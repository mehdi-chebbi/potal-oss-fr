          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-6">
              ...
              <input
                type="email"
                id="email"
                className="w-full px-4 py-3 border border-gray-200 rounded-xl shadow-sm bg-gray-50/50 focus:outline-none focus:ring-3 focus:ring-yellow-500/20 focus:border-yellow-500 transition-all duration-200 hover:bg-white"
                value={email}
            ...
            <div className="flex justify-end gap-4">
              ...
              <button
                type="submit"
                className="px-6 py-3 text-sm font-semibold text-white bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-xl hover:from-yellow-600 hover:to-yellow-700 active:from-yellow-700 active:to-yellow-800 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
                {t('login.submit')}
              </button>
            </div>
