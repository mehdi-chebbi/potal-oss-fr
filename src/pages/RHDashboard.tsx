...
const RHDashboard = () => {
  ...
  const fetchApplications = async () => {
    try {
      ...
      setError(t('rh.error.fetchApplications'));
    }
  };
  ...
  const handleDeleteApplication = async (id: number) => {
    if (window.confirm(t('rh.confirm.deleteApplication'))) {
      const token = localStorage.getItem('token');
  ...
  const downloadDocument = async (url: string, filename: string) => {
    try {
      ...
      alert(t('rh.alert.fetchDocumentFail'));
      console.error(err);
    }
  };
    ...
    <div className="py-8 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {activeTab === 'offers' && (
          <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <h2 className="text-3xl font-bold text-gray-900">{t('rh.manage.title')}</h2>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 mb-8">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                ...
                >
                  ...
                  {showOffersFilters ? t('rh.toggle.hide') : t('rh.toggle.show')}
                </button>
              </div>
              ...
              {showOffersFilters && (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-4">
                  <div>
                    <label htmlFor="offers-search" className="block text-sm font-medium text-gray-700 mb-1">{t('rh.search')}</label>
                  ...
                  <div>
                    <label htmlFor="offers-type" className="block text-sm font-medium text-gray-700 mb-1">{t('rh.type')}</label>
                    <select
                      id="offers-type"
                      name="type"
                  ...
                  <div>
                    <label htmlFor="offers-country" className="block text-sm font-medium text-gray-700 mb-1">{t('rh.country')}</label>
                    <select
                      id="offers-country"
                      name="country"
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500"
                  ...
                  <div>
                    <label htmlFor="offers-department" className="block text sm font-medium text-gray-700 mb-1">{t('rh.department')}</label>
                    <select
                  ...
                  <div>
                    <label htmlFor="offers-status" className="block text-sm font-medium text-gray-700 mb-1">{t('rh.status')}</label>
                    <select
                      id="offers-status"
                      name="status"
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500"
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {offersFilters.search && (
                  <span className="inline-flex items-center px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">
                    {t('rh.search')}: {offersFilters.search}
                    <button 
                ...
                {offersFilters.type && (
                  <span className="inline-flex items-center px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-sm">
                    {t('rh.type')}: {getOfferTypeInfo(offersFilters.type).name}
                    <button 
                ...
                {offersFilters.department && (
                  <span className="inline-flex items-center px-3 py-1 bg-yellow-100 text-yellow-800 rounded-full text-sm">
                    {t('rh.department')}: {offersFilters.department}
                    <button 
                ...
                {offersFilters.status && offersFilters.status !== 'ongoing' && (
                  <span className="inline-flex items-center px-3 py-1 bg-indigo-100 text-indigo-800 rounded-full text-sm">
                    {t('rh.status')}: {statusOptions.find(opt => opt.value === offersFilters.status)?.label}
                    <button 
              ...
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                <div className="px-6 py-4 bg-gray-50 border-b border-gray-200">
                  <h3 className="text-lg font-semibold text-gray-900">
                    {editingOffer ? t('rh.editOffer') : t('rh.createOffer')}
                  </h3>
                </div>
                <div className="p-6">
                  <OfferForm
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              {filteredOffers.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">{t('rh.noOffers.title')}</h3>
        ...
        {activeTab === 'applications' && (
          <div className="space-y-6">
            <div>
              <h2 className="text-3xl font-bold text-gray-900">{t('rh.tabs.applications')}</h2>
              <p className="text-gray-600 mt-1">{t('rh.manage.subtitle')}</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 mb-8">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                ...
                >
                  ...
                  {showApplicationsFilters ? t('rh.toggle.hide') : t('rh.toggle.show')}
                </button>
              </div>
              ...
              {showApplicationsFilters && (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                  <div>
                    <label htmlFor="applications-search" className="block text-sm font-medium text-gray-700 mb-1">{t('rh.search')}</label>
                    <div className="relative">
                      <input
                        type="text"
                  ...
                  <div>
                    <label htmlFor="applications-offerType" className="block text-sm font-medium text-gray-700 mb-1">{t('rh.label.offerType')}</label>
                    <select
                  ...
                  <div>
                    <label htmlFor="applications-department" className="block text-sm font-medium text-gray-700 mb-1">{t('rh.department')}</label>
                    <select
                  ...
                  <div>
                    <label htmlFor="applications-applicantCountry" className="block text-sm font-medium text-gray-700 mb-1">{t('rh.label.country')}</label>
                    <select
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {applicationsFilters.search && (
                  <span className="inline-flex items-center px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">
                    {t('rh.search')}: {applicationsFilters.search}
                    <button 
                ...
                {applicationsFilters.offerType && (
                  <span className="inline-flex items-center px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-sm">
                    {t('rh.type')}: {getOfferTypeInfo(applicationsFilters.offerType).name}
                    <button 
                ...
                {applicationsFilters.department && (
                  <span className="inline-flex items-center px-3 py-1 bg-yellow-100 text-yellow-800 rounded-full text-sm">
                    {t('rh.department')}: {applicationsFilters.department}
                    <button 
            ...
            {filteredApplications.length === 0 ? (
              <div className="bg-white rounded-xl shadow-sm border border-gray-200">
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">{t('rh.noApplications.title')}</h3>
                  <p className="text-gray-500">{t('rh.noApplications.subtitle')}</p>
                </div>
              </div>
            ) : (
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                          ...
                          <div className="flex items-center mb-2">
                            ...
                            <div>
                              ...
                              <div className="flex items-center text-sm text-gray-600 mt-1">
                                ...
                                {t('rh.modal.appliedFor')} <span className="font-medium text-gray-800 ml-1">{app.offer_title}</span>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">{t('rh.modal.appliedFor')} {selectedApplication.offer_title}</p>
                      </div>
                    </div>
                    <button
                ...
                <div className="px-6 py-6">
                  <div className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">{t('rh.label.email')}</label>
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">{t('rh.label.phone')}</label>
                        <div className="flex items-center p-3 bg-gray-50 rounded-lg">
                          <svg className="w-5 h-5 text-gray-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">{t('rh.label.country')}</label>
                        <div className="flex items-center p-3 bg-gray-50 rounded-lg">
                          <svg className="w-5 h-5 text-gray-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">{t('rh.label.offerType')}</label>
                        <div className="flex items-center p-3 bg-gray-50 rounded-lg">
                          <svg className="w-5 h-5 text-gray-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                      <h4 className="text-lg font-medium text-gray-900 mb-4">{t('rh.documents.title')}</h4>
