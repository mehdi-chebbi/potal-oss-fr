...
import { getCurrentLangFromPath, buildLangPath } from './utils/lang';
import { t } from './i18n';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <header className="bg-white shadow-lg border-b border-gray-200">
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="w-full py-4 flex items-center justify-between">
            <Link 
              to={user ? (user.role === 'rh' ? langPath('/rh-dashboard') : langPath('/admin-dashboard')) : langPath('/')} 
            ...
            <div className="flex items-center space-x-4">
              ...
              <button onClick={switchLang} className="px-3 py-2 text-sm rounded-lg border border-gray-200 hover:bg-gray-50">
                {lang === 'en' ? t(lang, 'nav.switch.to_fr') : t(lang, 'nav.switch.to_en')}
              </button>
                ...
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-3 px-4 py-2 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <div className={`hidden sm:flex px-2 py-1 rounded-full text-xs font-medium ${
                      ...
                      {user.role === 'admin' ? t(lang, 'nav.dashboard.admin') : t(lang, 'nav.dashboard.rh')}
                    </div>
                  </div>
                  <button 
                    onClick={onLogout} 
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 border-t border-gray-100">
              <div className="flex items-center space-x-2 text-sm">
                ...
                <span className="text-gray-700 font-medium capitalize">
                  {user.role === 'rh' ? t(lang, 'nav.dashboard.rh') : t(lang, 'nav.dashboard.admin')}
                </span>
              </div>
            </div>
          )}
      ...
      <main className="flex-1">
        <Routes>
          ...
          <Route path=":lang">
            <Route index element={user ? <Navigate to={user.role === 'rh' ? 'rh-dashboard' : 'admin-dashboard'} /> : <HomePage offers={offers} />} />
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Link to={langPath('/about')} className="block text-gray-600 hover:text-green-600 transition-colors">About OSS</Link>
      ...
      <LoginModal isOpen={showLogin} onClose={onCloseLogin} onLogin={onLogin} />
    </div>
  );
};
