...
const App = () => {
  ...
  return (
      <div className="min-h-screen bg-gradient-to-b from-white to-brandBlue/5">
        <header className="bg-white shadow-sm border-b border-brandBlue/20">
            ...
            <div className="w-full py-4 flex items-center justify-between">
              ...
              >
                <div className="relative">
                  <div className="h-12 w-12 rounded-xl bg-brandYellow flex items-center justify-center shadow-sm">
                    <span className="text-brandBlue font-bold text-lg">OSS</span>
                  </div>
                </div>
                <div className="ml-4">
                  <span className="text-2xl font-extrabold text-brandBlue">
                    {t('app.brand.title')}
                  </span>
                  <p className="text-sm text-brandBlue/80 font-medium">{t('app.brand.subtitle')}</p>
                </div>
              </LangLink>
              ...
              <div className="flex items-center space-x-4">
                <LangLink
                  to="/about"
                  className="hidden sm:inline-flex items-center px-4 py-2 text-brandBlue hover:text-brandBlue/90 font-medium rounded-lg hover:underline underline-offset-4 transition-colors duration-200"
                >
                ...
                {user ? (
                  <div className="flex items-center space-x-4">
                    <div className="flex items-center space-x-3 px-4 py-2 bg-brandBlue/5 rounded-lg border border-brandBlue/20">
                      ...
                      <div className="hidden sm:block">
                        <p className="text-sm font-medium text-brandBlue">{t('nav.welcome')}</p>
                        <p className="text-sm text-brandBlue/80 font-semibold">{user.name}</p>
                      </div>
                    ...
                    <button 
                      ...
                      className="inline-flex items-center px-4 py-2 border border-brandBlue/20 text-sm font-medium rounded-lg text-brandBlue bg-white hover:bg-brandBlue/5 focus:outline-none focus:ring-2 focus:ring-brandBlue/30 focus:ring-offset-0 transition-colors duration-200"
                    >
                  ...
                  <button 
                    ...
                    className="inline-flex items-center px-6 py-3 text-sm font-semibold rounded-lg text-brandBlue bg-brandYellow hover:brightness-95 focus:outline-none focus:ring-2 focus:ring-brandYellow/50 transition-colors duration-200 shadow-sm"
                  >
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <footer className="border-t-4 border-brandYellow bg-brandBlue mt-16 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="grid md:grid-cols-3 gap-8">
              <div className="space-y-4">
                <div className="flex items-center">
                  <div className="h-10 w-10 rounded-xl bg-brandYellow flex items-center justify-center shadow">
                    <span className="text-brandBlue font-bold text-lg">OSS</span>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <LangLink to="/about" className="block text-white/90 hover:text-white hover:underline underline-offset-4 transition-colors">{t('footer.about')}</LangLink>
                  <a href="#opportunities" className="block text-white/90 hover:text-white hover:underline underline-offset-4 transition-colors">{t('footer.currentOpportunities')}</a>
                  <a href="#" className="block text-white/90 hover:text-white hover:underline underline-offset-4 transition-colors">{t('footer.applicationProcess')}</a>
                  <a href="#" className="block text-white/90 hover:text-white hover:underline underline-offset-4 transition-colors">{t('footer.contactUs')}</a>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    <svg className="w-5 h-5 text-brandYellow mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
                    <p className="text-white/90 text-sm">{t('footer.location')}</p>
                  </div>
                  <div className="flex items-start space-x-3">
                    <svg className="w-5 h-5 text-brandYellow mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 7.89a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <p className="text-white/90 text-sm">careers@oss.org.tn</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 pt-8 border-t border-white/10">
              <div className="flex flex-col md:flex-row justify-between items-center">
                ...
                <div className="flex space-x-6 mt-4 md:mt-0">
                  <a href="#" className="text-white/80 hover:text-white text-sm transition-colors hover:underline underline-offset-4">{t('footer.privacy')}</a>
                  <a href="#" className="text-white/80 hover:text-white text-sm transition-colors hover:underline underline-offset-4">{t('footer.terms')}</a>
                  <a href="#" className="text-white/80 hover:text-white text-sm transition-colors hover:underline underline-offset-4">{t('footer.accessibility')}</a>
                </div>
              </div>
            </div>
          </div>
