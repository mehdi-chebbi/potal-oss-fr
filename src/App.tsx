          ...
          <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="w-full py-4 flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                <LangLink
                  to="/about"
                  className="hidden sm:inline-flex items-center px-4 py-2 text-gray-700 hover:text-yellow-600 font-medium rounded-lg hover:bg-yellow-50 transition-colors duration-200"
                >
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="space-y-4">
                <div className="flex items-center">
                  <div className="h-10 w-10 rounded-xl bg-gradient-to-r from-yellow-500 to-yellow-600 flex items-center justify-center">
                    <span className="text-white font-bold text-lg">OSS</span>
                  </div>
                ...
                <div className="flex space-x-4">
                  <div className="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center hover:bg-yellow-100 transition-colors cursor-pointer">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <LangLink to="/about" className="block text-gray-600 hover:text-yellow-600 transition-colors">{t('footer.about')}</LangLink>
                  <a href="#opportunities" className="block text-gray-600 hover:text-yellow-600 transition-colors">{t('footer.currentOpportunities')}</a>
                  <a href="#" className="block text-gray-600 hover:text-yellow-600 transition-colors">{t('footer.applicationProcess')}</a>
                  <a href="#" className="block text-gray-600 hover:text-yellow-600 transition-colors">{t('footer.contactUs')}</a>
                </div>
              </div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              <div className="flex flex-col md:flex-row justify-between items-center">
                ...
                <div className="flex space-x-6 mt-4 md:mt-0">
                  <a href="#" className="text-gray-500 hover:text-yellow-600 text-sm transition-colors">{t('footer.privacy')}</a>
                  <a href="#" className="text-gray-500 hover:text-yellow-600 text-sm transition-colors">{t('footer.terms')}</a>
                  <a href="#" className="text-gray-500 hover:text-yellow-600 text-sm transition-colors">{t('footer.accessibility')}</a>
                </div>
              </div>
            </div>
          </div>
